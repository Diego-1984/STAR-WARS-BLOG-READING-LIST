          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-6">
                ...
                <p1>{store.characterDetails.description}                
                </p1>
              </div>
              ...
              <div className="row text-danger">
                ...
                <div className="col-2">{store.characterDetails.birth_year}</div>
                <div className="col-2">{store.characterDetails.gender}</div>
                <div className="col-2">{store.characterDetails.height}</div>
                <div className="col-2">{store.characterDetails.skin_color}</div>
                <div className="col-2">{store.characterDetails.eye_color}</div>
              </div>
            </div>
          </div>
        </div>
